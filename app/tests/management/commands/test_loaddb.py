    ...
    def test_handle(self):
        ...
        expected = {
                ...
                to_datetime("2016-08-10 16:20:29.613320"): [
                    to_datetime("2016-08-10 16:20:29.613320"),
                    'Are there other cases where we might want this?  Maybe int'
                    'roduce a new WebInspector.KeyboardShortcut.eventHasCtrlOnM'
                    'ac() ?'],
                ...
                to_datetime("2015-06-01 15:47:51.006490"): [
                    to_datetime("2015-06-01 15:47:51.006490"),
                    'compatibility_script'],
                to_datetime("2016-07-20 17:20:45.982330"): [
                    to_datetime("2016-07-20 17:20:45.982330"),
                    'Add a TODO here to pass the availability_url into the obse'
                    'rver/callback, which will then decide the "overall" availa'
                    'bility to send back to the page.'],
                ...
                to_datetime("2015-08-14 20:04:31.153440"): [
                    to_datetime("2015-08-14 20:04:31.153440"),
                    'nit: spacing is off.'],
                to_datetime("2016-07-14 06:48:21.533000"): [
                    to_datetime("2016-07-14 06:48:21.533000"),
                    'Maybe" ? : " is better.\n\nUse NOTREACHED(); if keep curre'
                    'nt implementation.\nAnd the last return is useless.'],
                to_datetime("2016-07-19 12:45:03.266600"): [
                    to_datetime("2016-07-19 12:45:03.266600"),
                    'I\'m genuinely surprised this is a valid URL :) I would ex'
                    'pect something like "cast://google.com/?appid=deadbeef". I'
                    ' wonder how "appid=deadbeef" is parsed. Out of curiosity, '
                    'could that be "cast://deadbeef" ? Sounds like the "google.'
                    'com" part isn\'t really needed, is it?'],
                to_datetime("2016-07-14 06:48:21.644890"): [
                    to_datetime("2016-07-14 06:48:21.644890"),
                    'ASSERT(attachment == GL_DEPTH_ATTACHMENT || attachment == '
                ...
                to_datetime("2016-07-19 12:45:03.070610"): [
                    to_datetime("2016-07-19 12:45:03.070610"),
                    'nit: I am probably missing something but could you use `m_'
                    'urls` instead of `data` above?'],
                to_datetime("2016-06-13 18:19:46.637630"): [
                    to_datetime("2016-06-13 18:19:46.637630"),
                    'Since we split this to a separate C++ test fixture, how ab'
                    'out specifying browserPreload here and remove it from http'
                    's://cs.chromium.org/chromium/src/chrome/test/data/webui/se'
                    'ttings/pref_util_tests.js?l=11-12.'],
                ...
                to_datetime("2016-07-19 12:45:03.196690"): [
                    to_datetime("2016-07-19 12:45:03.196690"),
                    'We usually put a link on top of the IDL files for referenc'
                    'e.'],
                ...
                to_datetime("2016-07-08 13:16:37.047520"): [
                    to_datetime("2016-07-08 13:16:37.047520"),
                    'I think you still need to call this against `default_prefs'
                    '_`.'],
                ...
                to_datetime("2015-08-21 19:30:30.486850"): [
                    to_datetime("2015-08-21 19:30:30.486850"),
                    "Can't GetLevelSize() return true even though width and hei"
                    "ght are zero?"],
        ...
        expected = {to_datetime("2016-06-15 05:52:34.142650"): [to_datetime("2016-06-15 02:31:48.914370"), 'comment on the point of this'], to_datetime("2015-08-31 08:50:45.445550"): [to_datetime("2015-08-28 22:41:58.277110"), 'Update the version here.'], to_datetime("2016-07-27 22:06:30.261480"): [to_datetime("2016-07-27 20:44:06.925810"), 'This was used for autostart modules.'], to_datetime("2016-07-19 17:38:47.676770"): [to_datetime("2016-07-19 12:45:03.070610"), 'nit: I am probably missing something but could you use `m_urls` instead of `data` above?'], to_datetime("2015-08-31 07:07:02.637270"): [to_datetime("2015-08-28 07:16:49.330570"), 'Same comments about length computations.'], to_datetime("2016-07-27 22:06:30.310360"): [to_datetime("2016-07-27 20:44:07.033820"), 'Unused.'], to_datetime("2015-08-14 23:57:34.444240"): [to_datetime("2015-08-14 18:40:40.306130"), 'requestReload? reloadInspectedPage?'], to_datetime("2015-06-17 19:44:46.117540"): [to_datetime("2015-06-17 19:27:56.288510"), 'why the cast? why not \n\nif (applyingInPlace) {\n    *inv = storage;\n}\n'], to_datetime("2016-07-19 17:38:47.870840"): [to_datetime("2016-07-19 12:45:03.312060"), 'nit: |availabilityUrls|'], to_datetime("2016-07-27 22:06:30.209990"): [to_datetime("2016-07-27 20:44:06.878250"), 'style: missing semicolon'], to_datetime("2015-08-27 06:09:53.292350"): [to_datetime("2015-08-21 19:30:30.486850"), "Can't GetLevelSize() return true even though width and height are zero?"], to_datetime("2016-08-08 23:53:32.218620"): [to_datetime("2016-08-08 19:01:37.824650"), 'This is meant to be setOnKeyDownHandler.'], to_datetime("2016-08-10 23:31:08.082750"): [to_datetime("2016-08-10 23:13:43.652360"), 'Revert this one.'], to_datetime("2016-08-08 23:53:30.318460"): [to_datetime("2016-08-08 19:01:37.916060"), 'Delegate being an option sounds strange. Pass it explicitly.'], to_datetime("2016-07-19 17:38:47.778430"): [to_datetime("2016-07-19 12:45:03.196690"), 'We usually put a link on top of the IDL files for reference.'], to_datetime("2016-07-20 13:02:10.424420"): [to_datetime("2016-07-19 17:38:47.676770"), '\nWebVector does not provide any method to resize itself once allocated.  To populate the vector, the sample code suggests using swap().  See:\n\nhttps://cs-staging.chromium.org/chromium/src/third_party/WebKit/public/platform/WebVector.h?q=WebVector.h&sq=package:chromium&dr=CSs'], to_datetime("2015-07-31 01:06:50.969840"): [to_datetime("2015-07-30 18:24:22.252020"), 'Nit: No blank line here'], to_datetime("2016-08-08 23:53:33.174350"): [to_datetime("2016-08-08 19:01:37.730370"), 'Can we turn this into a function? Or even a Widget?'], to_datetime("2016-08-08 23:53:33.490080"): [to_datetime("2016-08-08 19:01:37.684220"), "Let's merge with previous one?"], to_datetime("2016-08-08 23:53:30.366890"): [to_datetime("2016-08-08 19:01:37.579210"), 'We usually call factory methods createSomething.'], to_datetime("2015-08-24 03:27:11.740570"): [to_datetime("2015-08-24 02:22:15.893870"), '\nIt would be better to use:\n\n  if (!isCurrentlyDisplayedInFrame())\n    return nullptr;\n\n'], to_datetime("2015-08-24 06:52:35.008600"): [to_datetime("2015-08-24 06:28:21.487230"), '\nCan you add a comment on this?\n'], to_datetime("2016-08-10 23:31:07.987820"): [to_datetime("2016-08-10 23:13:43.599280"), 'v8_only_frontend'], to_datetime("2016-08-11 22:06:23.211340"): [to_datetime("2016-08-10 16:32:25.888370"), 'Could you explain git what happened here (for the file in a separate change prior to doing this refactoring)'], to_datetime("2015-08-31 07:07:02.707860"): [to_datetime("2015-08-28 07:16:49.403850"), 'o -> object'], to_datetime("2016-08-08 23:53:32.936720"): [to_datetime("2016-08-08 19:01:37.778730"), 'Can we get rid of these?'], to_datetime("2016-08-11 22:06:23.088580"): [to_datetime("2016-08-10 16:20:29.669980"), 'Nit: insert newline above'], to_datetime("2016-07-11 08:21:00.643720"): [to_datetime("2016-07-08 13:16:37.047520"), 'I think you still need to call this against `default_prefs_`.'], to_datetime("2016-08-08 23:53:31.600620"): [to_datetime("2016-08-08 19:01:37.630140"), 'Is it actually a cancelAutocomplete?'], to_datetime("2015-08-14 23:57:34.481470"): [to_datetime("2015-08-14 20:04:31.153440"), 'nit: spacing is off.'], to_datetime("2016-08-10 23:31:07.938800"): [to_datetime("2016-08-10 23:13:43.472780"), 'Please change these to is_worker and is_v8_only.'], to_datetime("2016-07-19 17:38:47.630800"): [to_datetime("2016-07-19 12:45:03.109650"), "style: we don't use { } when not needed usually."], to_datetime("2015-06-02 10:51:56.799960"): [to_datetime("2015-06-01 15:47:51.006490"), 'compatibility_script'], to_datetime("2016-08-11 22:06:23.046620"): [to_datetime("2016-08-10 16:20:29.613320"), 'Are there other cases where we might want this?  Maybe introduce a new WebInspector.KeyboardShortcut.eventHasCtrlOnMac() ?'], to_datetime("2015-06-02 10:51:56.838570"): [to_datetime("2015-06-01 15:47:51.045690"), 'compatibility_script'], to_datetime("2016-08-10 23:31:08.030380"): [to_datetime("2016-08-10 23:13:43.524610"), 'Please change these to is_worker and is_v8_only.'], to_datetime("2016-07-19 17:38:47.733950"): [to_datetime("2016-07-19 12:45:03.151550"), 'style: maybe no { } ?'], to_datetime("2016-07-20 13:02:10.358540"): [to_datetime("2016-07-19 17:38:47.583740"), "\nWe don't know which URL is valid yet (they all need to get passed to the MR to create a sink -> URL map for the UI).\n\nI could land a patch to modify the PresentationService and downstream code to support multiple URLs first and land this afterwards, but we'd need to modify the dispatcher to convert the single URL argument to an array.\n\n"], to_datetime("2016-07-19 17:38:47.827700"): [to_datetime("2016-07-19 12:45:03.266600"), 'I\'m genuinely surprised this is a valid URL :) I would expect something like "cast://google.com/?appid=deadbeef". I wonder how "appid=deadbeef" is parsed. Out of curiosity, could that be "cast://deadbeef" ? Sounds like the "google.com" part isn\'t really needed, is it?'], to_datetime("2016-07-27 22:06:30.153200"): [to_datetime("2016-07-27 20:44:06.976080"), 'This is not proper English :-)']}
